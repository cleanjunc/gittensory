...
export const SELFHOST_ENV_REFERENCE_ROWS: SelfHostEnvReferenceRow[] = [
  ...
  {
    name: "AI_EMBED_MODEL",
    firstReference: "src/selfhost/ai.ts:1045",
  },
  {
    name: "AI_ON_MERGE",
    firstReference: "src/selfhost/ai.ts:1149",
  ...
  },
  {
    ...
    firstReference: "src/selfhost/ai.ts:1049",
  },
  {
    name: "ANTHROPIC_AI_MODEL",
    firstReference: "src/selfhost/ai.ts:109",
  },
  {
    name: "ANTHROPIC_API_KEY",
    firstReference: "src/selfhost/ai.ts:1048",
  },
  {
  ...
  },
  {
    ...
    firstReference: "src/selfhost/ai.ts:160",
  },
  {
  ...
  },
  {
    ...
    firstReference: "src/selfhost/ai.ts:164",
  },
  {
    name: "CODEX_AI_FIRST_OUTPUT_TIMEOUT_MS",
    firstReference: "src/selfhost/ai.ts:184",
  },
  {
    name: "CODEX_AI_MODEL",
    firstReference: "src/selfhost/ai.ts:105",
  },
  {
  ...
  {
    name: "CODEX_HOME",
    firstReference: "src/selfhost/ai.ts:353",
  },
  {
  ...
  },
  {
    ...
    firstReference: "src/selfhost/ai.ts:1042",
  },
  {
    name: "OLLAMA_AI_BASE_URL",
    firstReference: "src/selfhost/ai.ts:1038",
  },
  {
    name: "OLLAMA_AI_MODEL",
    firstReference: "src/selfhost/ai.ts:113",
  },
  {
    name: "OPENAI_AI_BASE_URL",
    firstReference: "src/selfhost/ai.ts:1040",
  },
  {
    name: "OPENAI_AI_MODEL",
    firstReference: "src/selfhost/ai.ts:114",
  },
  {
    name: "OPENAI_API_KEY",
    firstReference: "src/selfhost/ai.ts:1042",
  ...
  },
  {
    ...
    firstReference: "src/selfhost/ai.ts:1041",
  },
  {
    name: "OPENAI_COMPATIBLE_AI_MODEL",
    firstReference: "src/selfhost/ai.ts:115",
  },
  {
    name: "ORB_AIR_GAP",
...
export const SELFHOST_ENV_REFERENCE_MARKDOWN = [
  ...
  "| `ANTHROPIC_API_KEY` | `src/selfhost/ai.ts:1048` |",
  "| `BACKUP_ACKNOWLEDGED` | `src/server.ts:381` |",
  "| `BROWSER_WS_ENDPOINT` | `src/selfhost/stubs/puppeteer.ts:11` |",
  "| `CLAUDE_AI_EFFORT` | `src/selfhost/ai.ts:160` |",
  "| `CLAUDE_AI_MODEL` | `src/selfhost/ai.ts:101` |",
  "| `CLAUDE_AI_TIMEOUT_MS` | `src/selfhost/ai.ts:160` |",
  "| `CODEX_AI_EFFORT` | `src/selfhost/ai.ts:164` |",
  "| `CODEX_AI_FIRST_OUTPUT_TIMEOUT_MS` | `src/selfhost/ai.ts:184` |",
  "| `CODEX_AI_MODEL` | `src/selfhost/ai.ts:105` |",
  "| `CODEX_AI_TIMEOUT_MS` | `src/selfhost/ai.ts:164` |",
  "| `CODEX_HOME` | `src/selfhost/ai.ts:353` |",
  ...
  "| `OLLAMA_AI_API_KEY` | `src/selfhost/ai.ts:1042` |",
  "| `OLLAMA_AI_BASE_URL` | `src/selfhost/ai.ts:1038` |",
  "| `OLLAMA_AI_MODEL` | `src/selfhost/ai.ts:113` |",
  "| `OPENAI_AI_BASE_URL` | `src/selfhost/ai.ts:1040` |",
  "| `OPENAI_AI_MODEL` | `src/selfhost/ai.ts:114` |",
  "| `OPENAI_API_KEY` | `src/selfhost/ai.ts:1042` |",
  "| `OPENAI_COMPATIBLE_AI_API_KEY` | `src/selfhost/ai.ts:1042` |",
  "| `OPENAI_COMPATIBLE_AI_BASE_URL` | `src/selfhost/ai.ts:1041` |",
  "| `OPENAI_COMPATIBLE_AI_MODEL` | `src/selfhost/ai.ts:115` |",
